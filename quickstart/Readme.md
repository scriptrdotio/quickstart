...
This app assumes the user mobile phone as his device.
  ...
  - In order to get a deviceId, open the following URL from your mobile phone: https://<span></span><YOUR-SUB-DOMAIN>.scriptrapps.io/quickstart/simulator/phone.html. (make sure you allow the web app to your location service) 
